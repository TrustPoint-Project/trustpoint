...
#         return basekey
    ...
    # def verify_pbm_protection(self, pki_message, shared_secret: bytes) -> bool:
    #     """
    ...
    #     encoded_protected_part = encoder.encode(protected_part)
    #
    #     mac_value = hmac_lib.new(key, encoded_protected_part, 'sha1').digest()
    #
    #     if hmac_lib.compare_digest(protection.asOctets().hex(), mac_value.hex()):
