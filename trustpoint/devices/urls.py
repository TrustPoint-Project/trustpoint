...
urlpatterns = [
    ...
    path('onboarding/<int:pk>/manual/', views.DeviceManualOnboardingView.as_view(), name='manual'),
    # path('onboarding/<int:pk>manual/download-domain-credential/', views.DeviceManualOnboardingDownloadDomainCredentialView.as_view(), name='manual_download-domain-credential'),
    # path(
    ...
    # ),
    # path('certificate-lifecycle-management/generate-and-download-issued-credential/<int:pk>/',
    #     views.DeviceIssuedCredentialFormatSelectView.as_view(),
    #     name='generate_and_download_issued_credential'
    # ),
# path('certificate-lifecycle-management/download-issued-application-credential/<int:pk>/',
