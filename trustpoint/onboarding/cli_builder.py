...
class CliCommandBuilder:
    ...
    def cli_get_kdf(ctx: dict) -> str:
        ...
        return ('openssl kdf -keylen { PBKDF2_DKLEN } \\\n'
    ...
    def cli_calc_hmac() -> str:
        ...
        return 'cat tp-trust-store.pem | openssl dgst -sha256 -mac hmac -macopt hexkey:$(xxd -p -c 32 tp-key.bin) | tail -c 65 > tp.hmac'
    ...
    def cli_gen_key_and_csr() -> str:
        ...
        cmd = ('openssl  req -nodes -outform PEM -new -out ldevid-csr.pem \\\n'
