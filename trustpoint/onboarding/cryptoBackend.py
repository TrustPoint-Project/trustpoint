...
class CryptoBackend:
    ...
    def sign_ldevid(csr_str: str, device: Device):
        ...
        with open('../tests/data/x509/rsa-long.p12', 'rb') as cafile:
            ca_p12 = serialization.pkcs12.load_key_and_certificates(cafile.read(), b'testing321') # obviously TODO (open question: how does trustpoint store the pkcs12 password?)
