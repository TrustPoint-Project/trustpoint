...
@then(u'the certificate should be {revocation_status}')
def step_impl(context, revocation_status):
    raise StepNotImplementedError(f"The step to mark a certificate as {revocation_status} is not yet implemented.")
