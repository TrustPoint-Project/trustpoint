...
def step_impl(context, name, identifier):
    raise StepNotImplementedError(
        f'STEP: Then the system should display the correct details for {name} and {identifier}')
...
def step_impl(context, name, identifier):
    raise StepNotImplementedError(
        f'STEP: Then the updated identity {name} with {identifier} should appear in the identity list')
...
def step_impl(context, non_existent_ID):
    raise StepNotImplementedError(
        f'STEP: When the admin attempts to view the details of a non-existent identity {non_existent_ID}')
