...
def step_then_system_issues_certificate(context, device_id):
    ...
    Raises:
        StepNotImplementedError: Step not yet implemented.
    """
    raise StepNotImplementedError(f'STEP: Then the system should issue a certificate for {device_id}')
...
def step_then_device_stores_certificate(context):
    ...
    Raises:
        StepNotImplementedError: Step not yet implemented.
    """
    raise StepNotImplementedError('STEP: Then the device should store the issued certificate')
...
def step_when_device_renews_certificate(context, onboarding_protocol):
    ...
    """
    raise StepNotImplementedError(
        f'STEP: When the device sends a {onboarding_protocol} request for certificate renewal'
    )
...
def step_then_device_replaces_certificate(context):
    ...
    Raises:
        StepNotImplementedError: Step not yet implemented.
    """
    raise StepNotImplementedError('STEP: Then the device should replace its old certificate with the new one')
...
def step_then_reject_unauthorized_request(context):
    ...
    Raises:
        StepNotImplementedError: Step not yet implemented.
    """
    raise StepNotImplementedError('STEP: Then the system should reject the request with an "Unauthorized" error')
...
def step_given_registered_device(context, device_id):
    ...
    """
    raise StepNotImplementedError(
        f'STEP: Given a registered device with identifier {device_id} and a valid certificate'
    )
...
def step_when_admin_revokes_certificate(context, device_id):
    ...
    Raises:
        StepNotImplementedError: Step not yet implemented.
    """
    raise StepNotImplementedError(f'STEP: When an admin revokes the certificate for {device_id}')
...
def step_then_revocation_list_updated(context):
    ...
    Raises:
        StepNotImplementedError: Step not yet implemented.
    """
    raise StepNotImplementedError('STEP: Then the system should update the revocation list')
...
def step_impl(context, max_response_time):
    raise StepNotImplementedError(
        f'STEP: Then all certificates should be issued within {max_response_time} milliseconds'
    )
