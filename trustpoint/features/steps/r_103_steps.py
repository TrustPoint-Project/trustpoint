...
def step_given_component_has_security_level(context, component, security_level):
    ...
    Raises:
        StepNotImplementedError: Step not yet implemented.
    """
    raise StepNotImplementedError(f"STEP: Given the TrustPoint component {component} has security level {security_level}")
...
def step_then_security_level_persists(context, component, security_level):
    ...
    Raises:
        StepNotImplementedError: Step not yet implemented.
    """
    raise StepNotImplementedError(f"STEP: Then the TrustPoint component {component} should still have security level {security_level}")
