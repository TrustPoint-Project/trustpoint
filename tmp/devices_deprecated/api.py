...
#
#
# def device_api_dict(dev: DeviceModel) -> dict:
...
#         'onboarding_protocol': str(DeviceModel.OnboardingProtocol(dev.onboarding_protocol).label),
...
#     dev = DeviceModel.get_by_id(device_id)
#     if not dev:
